...
// Macros _CDC_, _HID_, _MSC_, and _PHDC_ are auto generated
// and defined in <descriptor.h> header file. When you add a
// USB class with the MSP Descriptor Tool, the corresponding
// macro will be added for you.
...
{
    //TO DO: You can place your code here
    if ( intfNum == KEYBOARD_HID_INTFNUM ) {
        KeyboardSendCompleted = true;
    }
